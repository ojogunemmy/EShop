    ...
    return(
        <div className='copyright'>
            ...
            <div style={{display:'flex',justifyContent:'space-evenly',marginBottom:'0px',marginLeft:'var(--margin)',marginRight:'var(--margin)',alignItems:'center',width:'92px' }} className="soc">
                <a href="https://web.facebook.com/pmawca/" style={{backgroundColor:'var(--light)',height:'20px',width:'20px',borderRadius:'50%',display:'flex',justifyContent:'center',alignItems:'center'}}><FaFacebook size={14} style={{color:'blue'}}/></a> 
                <a href="https://twitter.com/pmawca" style={{backgroundColor:'var(--light)',height:'20px',width:'20px',borderRadius:'50%',display:'flex',justifyContent:'center',alignItems:'center'}}><FaTwitter size={14} style={{color:'#1da1f2'}}/></a>
